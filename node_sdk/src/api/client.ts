...
export class APIClient extends APIServiceClient {
   ...
   * @param id trie Id
   * @param root trie root
   * @param anchorType the anchor type the trie proof should be submitted to. Default: `Anchor.Type.ETH`. You can find all available anchor types from [here](/node_sdk/reference/interfaces/_index_.anchor.typemap.html) and their descriptions from [here](https://docs.proofable.io/concepts/anchor_types.html)
   */
  createTrieProof(
    id: string,
    root: string,
