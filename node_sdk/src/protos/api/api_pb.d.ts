...
export class TrieProof extends jspb.Message { 
    ...
    getStatus(): anchor_anchor_pb.Batch.Status;
    setStatus(value: anchor_anchor_pb.Batch.Status): void;

    getError(): string;
    setError(value: string): void;

    getAnchorType(): anchor_anchor_pb.Anchor.Type;
    setAnchorType(value: anchor_anchor_pb.Anchor.Type): void;
...
export namespace TrieProof {
    export type AsObject = {
        ...
        root: string,
        createdAt?: google_protobuf_timestamp_pb.Timestamp.AsObject,
        status: anchor_anchor_pb.Batch.Status,
        error: string,
        anchorType: anchor_anchor_pb.Anchor.Type,
        txnId: string,
        txnUri: string,
        blockTime: number,
        blockNumber: number,
