...
package api // import "github.com/SouthbankSoftware/provenx-cli/pkg/protos/api"

import proto "github.com/golang/protobuf/proto"
import fmt "fmt"
import math "math"
import anchor "github.com/SouthbankSoftware/provenx-cli/pkg/protos/anchor"
...
var fileDescriptor_api_6d362cca6cc03151 = []byte{
	...
	,
}
