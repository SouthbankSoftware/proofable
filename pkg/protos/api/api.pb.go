...
func (x Trie_StorageType) String() string {
	return proto.EnumName(Trie_StorageType_name, int32(x))
}
func (Trie_StorageType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_api_2700c157b58452d1, []int{0, 0}
}
...
type Trie struct {
	...
	StorageType          Trie_StorageType `protobuf:"varint,3,opt,name=storage_type,json=storageType,proto3,enum=api.Trie_StorageType" json:"storage_type,omitempty"`
...
func (*Trie) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_2700c157b58452d1, []int{0}
}
...
func (*DataChunk) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_2700c157b58452d1, []int{1}
}
...
func (*DataChunk_ImportTrieRequest) isDataChunk_Metadata() {}
...
func (m *DataChunk) GetImportTrieRequest() *ImportTrieRequest {
	if x, ok := m.GetMetadata().(*DataChunk_ImportTrieRequest); ok {
		return x.ImportTrieRequest
	}
	return nil
}
...
func (*DataChunk) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _DataChunk_OneofMarshaler, _DataChunk_OneofUnmarshaler, _DataChunk_OneofSizer, []interface{}{
		(*DataChunk_ImportTrieRequest)(nil),
...
func _DataChunk_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *DataChunk_ImportTrieRequest:
		b.EncodeVarint(2<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.ImportTrieRequest); err != nil {
			return err
		}
...
func _DataChunk_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*DataChunk)
	switch tag {
	case 2: // metadata.import_trie_request
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ImportTrieRequest)
		err := b.DecodeMessage(msg)
		m.Metadata = &DataChunk_ImportTrieRequest{msg}
		return true, err
...
func _DataChunk_OneofSizer(msg proto.Message) (n int) {
	...
	switch x := m.Metadata.(type) {
	case *DataChunk_ImportTrieRequest:
		s := proto.Size(x.ImportTrieRequest)
		n += 1 // tag and wire
...
func (*KeyValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_2700c157b58452d1, []int{2}
}
...
func (*VerifyProofReplyChunk) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_2700c157b58452d1, []int{3}
}
...
func (*Key) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_2700c157b58452d1, []int{4}
}
...
func (*TrieRoot) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_2700c157b58452d1, []int{5}
}
...
func (*TrieProof) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_2700c157b58452d1, []int{6}
}
...
func (*RootFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_2700c157b58452d1, []int{7}
}
...
func (*KeyValuesFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_2700c157b58452d1, []int{8}
}
...
func (*TrieRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_2700c157b58452d1, []int{9}
}
...
func (*TrieKeyValuesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_2700c157b58452d1, []int{10}
}
...
func (*TrieKeyValueRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_2700c157b58452d1, []int{11}
}
...
func (*TrieRootsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_2700c157b58452d1, []int{12}
}
...
func (*SetTrieRootRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_2700c157b58452d1, []int{13}
}
...
type SetTrieStorageTypeRequest struct {
	// TrieId is the trie ID
	TrieId string `protobuf:"bytes,1,opt,name=trie_id,json=trieId,proto3" json:"trie_id,omitempty"`
	// StorageType is the storage type of the trie to be updated to
	StorageType          Trie_StorageType `protobuf:"varint,2,opt,name=storage_type,json=storageType,proto3,enum=api.Trie_StorageType" json:"storage_type,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}

func (m *SetTrieStorageTypeRequest) Reset()         { *m = SetTrieStorageTypeRequest{} }
func (m *SetTrieStorageTypeRequest) String() string { return proto.CompactTextString(m) }
func (*SetTrieStorageTypeRequest) ProtoMessage()    {}
func (*SetTrieStorageTypeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_2700c157b58452d1, []int{14}
}
func (m *SetTrieStorageTypeRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_SetTrieStorageTypeRequest.Unmarshal(m, b)
}
func (m *SetTrieStorageTypeRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_SetTrieStorageTypeRequest.Marshal(b, m, deterministic)
}
func (dst *SetTrieStorageTypeRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SetTrieStorageTypeRequest.Merge(dst, src)
}
func (m *SetTrieStorageTypeRequest) XXX_Size() int {
	return xxx_messageInfo_SetTrieStorageTypeRequest.Size(m)
}
func (m *SetTrieStorageTypeRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_SetTrieStorageTypeRequest.DiscardUnknown(m)
}

var xxx_messageInfo_SetTrieStorageTypeRequest proto.InternalMessageInfo
...
func (*TrieProofsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_2700c157b58452d1, []int{15}
}
...
func (*TrieProofRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_2700c157b58452d1, []int{16}
}
...
type CreateTrieRequest struct {
	...
	StorageType          Trie_StorageType `protobuf:"varint,1,opt,name=storage_type,json=storageType,proto3,enum=api.Trie_StorageType" json:"storage_type,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (*CreateTrieRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_2700c157b58452d1, []int{17}
}
...
func (dst *CreateTrieRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CreateTrieRequest.Merge(dst, src)
}
...
func (m *ImportTrieRequest) Reset()         { *m = ImportTrieRequest{} }
func (m *ImportTrieRequest) String() string { return proto.CompactTextString(m) }
func (*ImportTrieRequest) ProtoMessage()    {}
func (*ImportTrieRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_2700c157b58452d1, []int{18}
}
func (m *ImportTrieRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ImportTrieRequest.Unmarshal(m, b)
}
func (m *ImportTrieRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ImportTrieRequest.Marshal(b, m, deterministic)
}
func (dst *ImportTrieRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ImportTrieRequest.Merge(dst, src)
}
func (m *ImportTrieRequest) XXX_Size() int {
	return xxx_messageInfo_ImportTrieRequest.Size(m)
}
func (m *ImportTrieRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ImportTrieRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ImportTrieRequest proto.InternalMessageInfo
...
func (*CreateTrieProofRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_2700c157b58452d1, []int{19}
}
...
func (*DeleteTrieProofRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_2700c157b58452d1, []int{20}
}
...
func (*VerifyTrieProofRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_2700c157b58452d1, []int{21}
}
...
func (*CreateKeyValuesProofRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_2700c157b58452d1, []int{22}
}
...
func (*VerifyKeyValuesProofRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_2700c157b58452d1, []int{23}
}
...
func (*VerifyProofReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_2700c157b58452d1, []int{24}
}
...
func init() {
	...
	proto.RegisterType((*SetTrieStorageTypeRequest)(nil), "api.SetTrieStorageTypeRequest")
	...
	proto.RegisterType((*CreateTrieRequest)(nil), "api.CreateTrieRequest")
	proto.RegisterType((*ImportTrieRequest)(nil), "api.ImportTrieRequest")
	...
	proto.RegisterEnum("api.Trie_StorageType", Trie_StorageType_name, Trie_StorageType_value)
}
...
type APIServiceClient interface {
	...
	CreateTrie(ctx context.Context, in *CreateTrieRequest, opts ...grpc.CallOption) (*Trie, error)
	...
	SetTrieStorageType(ctx context.Context, in *SetTrieStorageTypeRequest, opts ...grpc.CallOption) (*Trie, error)
...
func (c *aPIServiceClient) CreateTrie(ctx context.Context, in *CreateTrieRequest, opts ...grpc.CallOption) (*Trie, error) {
	out := new(Trie)
...
func (c *aPIServiceClient) SetTrieStorageType(ctx context.Context, in *SetTrieStorageTypeRequest, opts ...grpc.CallOption) (*Trie, error) {
	out := new(Trie)
	err := c.cc.Invoke(ctx, "/api.APIService/SetTrieStorageType", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type APIServiceServer interface {
	...
	// CreateTrie creates an empty trie
	CreateTrie(context.Context, *CreateTrieRequest) (*Trie, error)
	// DeleteTrie deletes a trie. This destroys everything of a trie
	...
	// SetTrieStorageType sets the storage type of a trie
	SetTrieStorageType(context.Context, *SetTrieStorageTypeRequest) (*Trie, error)
	// GetTrieProofs gets proofs of a trie
...
func _APIService_CreateTrie_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServiceServer).CreateTrie(ctx, req.(*CreateTrieRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _APIService_SetTrieStorageType_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetTrieStorageTypeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServiceServer).SetTrieStorageType(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.APIService/SetTrieStorageType",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServiceServer).SetTrieStorageType(ctx, req.(*SetTrieStorageTypeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _APIService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetTrieStorageType",
			Handler:    _APIService_SetTrieStorageType_Handler,
		},
		{
...
func init() { proto.RegisterFile("api/api.proto", fileDescriptor_api_2700c157b58452d1) }

var fileDescriptor_api_2700c157b58452d1 = []byte{
	// 1437 bytes of a gzipped FileDescriptorProto
	,
}
